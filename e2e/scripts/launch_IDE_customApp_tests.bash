...
if [ ! -d ../test-tools ]; then
	...
	cp  e2e/test-tools/e2e/cucumber.js ../test-tools/e2e/.
	cat e2e/test-tools/e2e/features/support/steps_diff.ts >> ../test-tools/e2e/features/support/steps.ts
	status_cat=$?
